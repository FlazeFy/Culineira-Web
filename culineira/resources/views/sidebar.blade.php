<nav id="sidebar">
    <div class="p-4 pt-2 position-relative h-100">
        ...
        <button class="btn btn-danger position-absolute" style="bottom:10px;" onclick="location.href='{{ url('/') }}'">Sign-Out</button>
        <button class="btn btn-primary position-absolute" style="bottom:10px; right:10px;" id="theme-toggle"><span id="theme"></span> Mode</button>
    </div>
</nav>