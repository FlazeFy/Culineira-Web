    ...
    <div class='row'>
        <div class='col-sm-4'>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" id="searchInput" onkeyup="searchName()" name="search" placeholder="username, or groupname" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            </form>
        </div>
        <div class='col-sm-3 mt-1'>
            <select class="form-select" aria-label="Default select example">
                ...
                @foreach (\App\Models\search_config::all() as $item)
                    @if($item->config_type == 'global_type')
...
<script>
    function searchName() {
        ...
        ul = document.getElementById("global_list_holder");
        li = ul.getElementsByTagName("li");
        for (i = 0; i < li.length; i++) {
            name = li[i].getElementsByTagName("span")[0];
    ...
    var recipeName = [
        @foreach($global as $data)<?php echo "'"; echo $data->name; echo "',"; ?>@endforeach
    ];
