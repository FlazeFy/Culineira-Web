                                ...
                                <div class="row py-4" id="recipe_list_holder">
                                    @foreach($recipeInList as $rl)
                                        @foreach($user as $data2)
                                            ...
                                            <div class="card border-gray w-25 p-2 border mx-2 my-3" style='min-width:250px;'>
                                                ...
                                                <div class='row mt-2' style='justify-content:center; width:110%;'>
                                                        ...
                                                        <div class='col-md-4'>
                                                            <p style='font-size:11px; justify-content:center; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; line-clamp: 2; -webkit-box-orient: vertical;'>{{$rl->recipe_main_ing}}</p>
                                                        </div>
                                                    </div>
