...
<div class="scrolling-wrapper py-2">
    ...
    <div class="card border-0 bg-transparent m-0">
        <img class="img rounded-circle m-1 border-0 shadow" style="width:65px;" src="http://127.0.0.1:8000/assets/achievement/achievement-3.png" type="button" role="button" data-bs-toggle="popover"
    ...
    <div class="card border-0 bg-transparent m-0">
        <img class="img rounded-circle m-1 border-0 shadow" style="width:65px;" src="http://127.0.0.1:8000/assets/achievement/achievement-5.png" type="button" role="button" data-bs-toggle="popover"
            title="Master Chef" data-bs-content="Have won competition">
    </div>
    <div class="card border-0 bg-transparent m-0">
        <img class="img rounded-circle m-1 border-0 shadow" style="width:65px; background:#473080;" src="http://127.0.0.1:8000/assets/achievement/achievement-6.png" type="button" role="button" data-bs-toggle="popover"
    ...
    <div class="card border-0 bg-transparent m-0">
        <img class="img rounded-circle m-1 border-0 shadow" style="width:65px;" src="http://127.0.0.1:8000/assets/achievement/achievement-8.png" type="button" role="button" data-bs-toggle="popover"
